...
function draw() {
  ...
  if (mouseX > 70 && mouseX < 70 + otrosProyectosTextWidth && mouseY > height - 100 && mouseY < height - 80) {
    cursor(HAND);
    if (mouseIsPressed) {
      // Abrir la página web en la misma ventana (reemplaza la página actual)
      window.location.href = 'https://wiki.ead.pucv.cl/Javiera_Iturrieta';
    }
  } else {
    cursor(ARROW);
  }
  ...
  checkClick(mx, my) {
    ...
    if (d < 35) {
      ...
      switch (this.number) {
        case 1:
          // Abrir la página web en la misma ventana (reemplaza la página actual)
          window.location.href = 'https://javieraiturrieta.github.io/ie2023-01/';
          break;
        case 2:
          // Abrir la página web en la misma ventana (reemplaza la página actual)
          window.location.href = 'https://javieraiturrieta.github.io/ie2023-02/';
          break;
        case 3:
          // Abrir la página web en la misma ventana (reemplaza la página actual)
          window.location.href = 'https://javieraiturrieta.github.io/ie2023-03/';
          break;
        case 4:
          // Abrir la página web en la misma ventana (reemplaza la página actual)
          window.location.href = 'https://javieraiturrieta.github.io/ie23-04/';
          break;
        case 5:
          // Abrir la página web en la misma ventana (reemplaza la página actual)
          window.location.href = 'https://javieraiturrieta.github.io/ie2023-05/';
          break;
        case 6:
          // Abrir la página web en la misma ventana (reemplaza la página actual)
          window.location.href = 'https://javieraiturrieta.github.io/ie2023-tarea-6/';
          break;
        default:
          break;
      }
